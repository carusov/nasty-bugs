...
data_path <- "~/osphl/validation/within_precision"
...
summary_stats <- tibble(sample_name = character(),
                        ...
                        base_calls_in_common = integer(),
                        pct_coverage = numeric(),
                        total_SNPs = integer(),
                        num_errors = integer(),
                        pct_precision = numeric(),
                        err_per_M = numeric())
...
write_tsv(summary_stats, file.path(data_path, "within_precision_summary.tsv"))
